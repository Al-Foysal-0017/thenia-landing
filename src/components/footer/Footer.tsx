...
import imageCircle from "../../assets/svg/Discord-badge.svg";
    ...
    <Container>
      ...
      {pathname !== "/privacy-policy" && (
        <div className="footer_image">
          <img src={discordImg} alt="" style={{ position: "absolute" }} />
          <a
            href="https://discord.com/invite/sjBjnQkEYP"
            target="_blank"
            rel="noreferrer"
          >
            <img src={imageCircle} className="animate-spin" alt="" />
          </a>
        </div>
      )}
          ...
          {data.map((item, index) => (
            ...
            >
              <a href={item.href} target="_blank" rel="noreferrer">
                <span className="footer__links__link__icon">{item.logo}</span>
                {item.name}
              </a>
            </motion.div>
          ))}
